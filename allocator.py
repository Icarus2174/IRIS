...
def allocate(ir: IR) -> Allocation:
    ...
    allow_hybrid = bool(ir.space_constraints.get("orbit_candidate")) and True
    # Note: runtime_policy.allow_hybrid is carried via intent->IR in this prototype as candidates,
    # but we still make a conservative selection below.
