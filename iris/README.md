...
python -m main --case case_training_space.yaml
python -m main --case case_inference_earth.yaml
python -m main --case case_archive_orbit.yaml
python -m main --case case_runtime_alert.yaml
python -m verify_cases
```

Outputs are written to `outputs/<case_name>/`.
